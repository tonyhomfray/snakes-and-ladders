...
const startButton = "<button id='startGame' class='button start-button' onclick='startGame()'>Start Game</button>";

const takeTurnButton = "<button id='takeTurn' class='button take-turn-button' onclick='takeTurn()'>Take Turn</button>";

const resetButton = "<button id='reset' class='button reset-button' onclick='resetGame()'>Reset</button>";
...
// takeTurn(player1);
// gameLoop();
>>>>>>> f2c0250 (Pushing everything prior to deleting from local machine to make space)
